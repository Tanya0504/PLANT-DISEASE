...
I then plotted a RGB value histogram(Red Green Blue) for both healthy as well as a disease leaf for a partiular plant. I repeated this for multiple plant species (5 species to be specific) to strengthen and reach at a  conclusion:
Healthy leaves are and  generally show balanced, mid-range RGB peaks, where as the diseased ones (like scab or blight) showed shifts to lower intensities, indicating darker patches and lesion areas.
These pixel intensity differences  led me to confirm that color will be  a strong signal for classification.
